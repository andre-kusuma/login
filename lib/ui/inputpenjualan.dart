...
class MyCustomFormState extends State<MyCustomForm> {   
  ...
  Future<http.Response> adddata(index) async{       
    ...
    if(index==null){         
      ...
      final http.Response response = await http.post("http://192.168.43.149/rest_api/index.php/penjualan/save",body: {          
        ...
        return response;        
          ...
          final http.Response response = await http.post("http://192.168.43.149/rest_api/index.php/penjualan/save_update",body: {           
            'id':widget.list['id'],           
            'nama':nameController.text,           
            'keterangan':keteranganController.text,           
            'jumlah':jumlahController.text,           
